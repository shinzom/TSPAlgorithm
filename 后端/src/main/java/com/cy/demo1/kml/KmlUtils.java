...
//	        iconElement.addElement("href").addText("http://192.168.10.108:8080/images/mark_b.png");//在线图标
     ...
     /*  Element lineStyleElement = styleElement.addElement("LineStyle");
        ...
        XMLWriter xmlWriter = new XMLWriter(new FileOutputStream("C:/Users/tanxy/Desktop/tsp/kml/airportData/" + fileName + "_1.kml"), format);
        ...
        strs[0] = "C:/Users/tanxy/Desktop/tsp/kml/Travels/" + fileName + "_1.kml";
        strs[1] = "C:/Users/tanxy/Desktop/tsp/kml/Travels/images/img_mark.png";//这里写图片的路径  如果使用在线图标这段代码屏蔽
        writeKml(strs, "C:/Users/tanxy/Desktop/tsp/kml/Travels/" + fileName);//压缩
